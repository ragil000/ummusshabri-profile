                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry">
                            ...
                            <h2 class="entry-title">
                                <a href="<?=base_url('litbang/detail/inovasi-pelayanan-publik/').$value['slug']?>"><?=_limitText($value['title'], 170)?></a>
                            </h2>
                            ...
                            <div class="entry-content">
                                ...
                                <div class="read-more">
                                    <a href="<?=base_url('litbang/detail/inovasi-pelayanan-publik/').$value['slug']?>">Lihat detail</a>
                                </div>
                            </div>

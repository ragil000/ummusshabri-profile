<div class="row mt-5">
    <div class="col-12">
        <form method="POST" action="<?=base_url('admin/galery/put/'.$slug.'/').$id?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="file" id="input-image" class="custom-file-input rmy-validation" data-mime="video/mp4" lang="en" value="<?=$data[0]['file']?>">

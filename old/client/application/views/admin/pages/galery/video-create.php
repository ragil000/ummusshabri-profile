                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="file" id="input-video" class="custom-file-input rmy-validation" data-mime="video/mp4" lang="en">
                                    <label class="custom-file-label" for="input-video">Pilih video</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">

...
class Journal extends CI_Controller {
	...
	public function index($level, $content = 'rik-bombana')
	{
    ...
    $data['isi'] = $this->load->view('pages/journal/'.$content, $data, true);
    ...
    $data['levelLink'] = $level.'/';
    $data['header'] = $this->load->view('templates2/header', $data, true);
    $data['isi'] = $this->load->view('pages/journal/'.$content.'-detail', '', true);
    $this->load->view('templates2/index', $data);
		// $this->load->view('templates/header');
		// $this->load->view('templates/head-content', $data);

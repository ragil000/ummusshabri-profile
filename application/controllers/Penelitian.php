...
class Penelitian extends CI_Controller {
	...
	public function index($level,$content = 'usulan-penelitian') {
    ...
    $data['isi'] = $this->load->view('pages/'.$content, $data, true);
	...
	public function post($level) {
		...
		if($results['status']) {
			...
			redirect(base_url($level.'/usulan-penelitian'));
		}else {

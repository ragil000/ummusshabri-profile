...
<head>
  ...
  <!-- Favicons -->
  <link href="<?=base_url('template/awal')?>/assets/img/favicon.png" rel="icon">
  ...
  <link href="<?=base_url('template/awal')?>/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
  ...
  <link href="<?=base_url('template/awal')?>/assets/css/style2.css" rel="stylesheet">
  ...
  <header id="header" class="fixed-top ">
    <div class="container">
      ...
      <div class="logo float-left">
        ...
        <!-- <a href="index.html"><img src="<?=base_url('template/awal')?>/assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>

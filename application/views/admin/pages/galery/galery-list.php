            ...
            <div class="card-header border-0">
              <div class="row">
                ...
                <div class="col-lg-8 text-left">
                  <a href="<?=base_url('admin/galery/create')?>" class="btn btn-primary"><i class="ni ni-single-copy-04"></i> Tambah</a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?=base_url('admin/galery/update/').$value['id']?>" class="btn btn-sm btn-warning"><i class="fa fa-pen"></i></a>

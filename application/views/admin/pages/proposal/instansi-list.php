            ...
            <div class="card-header border-0">
              <div class="row">
                ...
                <div class="col-lg-10 text-left">
                  <a href="<?=base_url('admin/proposal/create/instansi')?>" class="btn btn-primary"><i class="ni ni-single-copy-04"></i> Tambah</a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?=base_url('admin/proposal/update/instansi/').$value['id']?>" class="btn btn-sm btn-warning"><i class="fa fa-pen"></i></a>

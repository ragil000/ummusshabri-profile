<div class="row mt-5">
    <div class="col-12">
        <form method="POST" action="<?=base_url('admin/profile/put/').$id?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                            <button type="button" onclick="window.location='<?=base_url('admin/profile')?>'" class="btn btn-warning mt-4">Kembali</button>

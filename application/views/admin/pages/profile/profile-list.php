            ...
            <div class="card-header border-0">
              <div class="row">
                ...
                <!-- <div class="col-lg-9 text-left">
                  <a href="<?=base_url('admin/profile/create/')?>" class="btn btn-primary"><i class="ni ni-single-copy-04"></i> Tambah</a>
                </div> -->
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="<?=base_url($value['level'].'/profile')?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                            <a href="<?=base_url('admin/profile/update/').$value['id']?>" class="btn btn-sm btn-warning"><i class="fa fa-pen"></i></a>

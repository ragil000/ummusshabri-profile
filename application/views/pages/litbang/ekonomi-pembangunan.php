                ...
                <ol>
                    <?php
                        foreach($link_map as $link) {
                          ...
                          // $setLink = explode(base_url(), $link['slug']);
                          // print_r($link);
                    ?>
                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry">
                            ...
                            <h2 class="entry-title">
                                <a href="<?=base_url($levelLink.'litbang/detail/ekonomi-pembangunan/').$value['slug']?>"><?=_limitText($value['title'], 170)?></a>
                            </h2>
                            ...
                            <div class="entry-content">
                                ...
                                <div class="read-more">
                                    <a href="<?=base_url($levelLink.'litbang/detail/ekonomi-pembangunan/').$value['slug']?>">Lihat detail</a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-item categories">
                            <ul>
                                <?php
                                    ...
                                    $setLink = explode(base_url(), $submenu['slug']);
                                ?>
                                <li><a href="<?=base_url($levelLink.@$setLink[1])?>"><?=$submenu['title']?> <?=!empty($submenu['total']) ? '<span>('.$submenu['total'].')</span>' : '' ?></a></li>
                                <?php
                                    }
                                ?>
                            </ul>
                        ...
                        <div class="sidebar-item recent-posts">
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="<?=base_url($levelLink.'journal/detail/artikel-berita/').$value['slug']?>"><?=_limitText($value['title'],35)?></a></h4>

        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="<?=base_url('template/awal')?>/assets/img/blog-post-1.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="<?=base_url('template/awal')?>/assets/img/blog-post-2.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="<?=base_url('template/awal')?>/assets/img/blog-post-3.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="<?=base_url('template/awal')?>/assets/img/blog-post-4.jpg" alt="" class="img-fluid">
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="<?=base_url('template/awal')?>/assets/img/recent-posts-1.jpg" alt="">
                  <h4><a href="blog-single.html">Nihil blanditiis at in nihil autem</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="<?=base_url('template/awal')?>/assets/img/recent-posts-2.jpg" alt="">
                  <h4><a href="blog-single.html">Quidem autem et impedit</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="<?=base_url('template/awal')?>/assets/img/recent-posts-3.jpg" alt="">
                  <h4><a href="blog-single.html">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="<?=base_url('template/awal')?>/assets/img/recent-posts-4.jpg" alt="">
                  <h4><a href="blog-single.html">Laborum corporis quo dara net para</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="<?=base_url('template/awal')?>/assets/img/recent-posts-5.jpg" alt="">
